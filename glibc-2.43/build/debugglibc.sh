...
SOURCE_DIR="/home/nestos/test/glibc-2.43"
BUILD_DIR="/home/nestos/test/glibc-2.43/build/"
CMD_FILE="/home/nestos/test/glibc-2.43/build/debugglibc.gdb"
CONTAINER=false
DIRECT=true
STATIC=false
SYMBOLSFILE=true
...
WAIT_FOR_DEBUGGER=1 /home/nestos/test/glibc-2.43/build/testrun.sh --tool=container ${TESTCASE} &
gdb -x ${TESTCASE}.gdb
elif [ "$STATIC" == true ]
then
gdb ${TESTCASE}
